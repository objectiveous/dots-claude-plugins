...
!HOOK_SCRIPT=$(ls -t ${DOTS_SWE_DEV:-/nonexistent}/scripts/commit-msg-hook.sh $HOME/.claude/plugins/cache/dots-claude-plugins/dots-swe/*/scripts/commit-msg-hook.sh 2>/dev/null | head -1)
