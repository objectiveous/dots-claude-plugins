...
!echo "  bd blocked                   - List blocked issues"
!echo ""
!echo "Visualize dependencies:"
!echo "  /dots-swe:deps               - Project dependency overview"
!echo "  /dots-swe:deps <id>          - Dependency tree for specific bead"
!echo "  bd dep tree <id>             - Show dependency tree (raw)"
!echo "  bd dep list <id>             - List dependencies/dependents"
!echo ""
!echo "Update beads:"
